...
### Aplicación para descarga de video/audio para Android
...
- Descargar archivos de video y audio de plataformas de video compatibles con [yt-dlp](https://github.com/yt-dlp/yt-dlp) (antes conocido como youtube-dl).

- Añadir metadatos y miniatura de video a archivos de audio compatibles con [mutagen](https://github.com/quodlibet/mutagen).

- Descargar todos los videos de una lista de reproducción con un click.

- Uso de [aria2c](https://github.com/aria2/aria2) como programa externo de descarga para todas tus descargas.

- Añadir subtítulos a los videos descargados.

- Ejecutar comandos personalizados de yt-dlp con uso de plantillas.

- Administrar descargas en la aplicación y plantillas personalizadas para comandos.

- Facil de usar y amigable al usuario.

- Estilo de UI [Material Design 3](https://m3.material.io/), con temas de colores dinámicos.

- MAD: La lógica y UI estan escritos puramente en Kotlin. Solo hay una única actividad, sin fragmentos, solo destinos compuestos.



## ⬇️ Descargar

Para la mayoría de dispositivos, es recomendado instalar la version **arm64-v8a** de los apks

- Descarga la ultima version estable desde [GitHub releases](https://github.com/JunkFood02/Seal/releases/latest)
  - Instala las versiones [pre-release](https://github.com/JunkFood02/Seal/releases/) para ayudarnos a experimentar nuevas funciones y cambios

- Las versiones estavles estan disponibles en [F-Droid](https://f-droid.org/packages/com.junkfood.seal/)
...
Únete a nuestro [canal de Telegram](https://t.me/seal_app) o [espacio en Matrix](https://matrix.to/#/#seal-space:matrix.org) para discuciones, anuncios y nuevos lanzamientos!
...
Seal es y siempre será Software Libre. Si te gusta, por favor considera [apoyarme!](https://github.com/sponsors/JunkFood02)!

## 🤝 Contribuir

Las contribuciones son bienvenidas!

Puedes traducir Seal en [Hosted Weblate](https://hosted.weblate.org/projects/seal/).
	
[![Translate status](https://hosted.weblate.org/widgets/seal/-/strings/multi-auto.svg)](https://hosted.weblate.org/engage/seal/)
	
>[!Nota]
>
>Para enviar reportes de bugs, solicitudes de funciones, preguntas, o cualquier otra idea para mejorar, por favor primero lea [CONTRIBUTING.md](https://github.com/JunkFood02/Seal/blob/main/CONTRIBUTING.md) para ver las pautas e instrucciones.
...
Seal es una simple GUI de [yt-dlp](https://github.com/yt-dlp/yt-dlp), que está basado en [youtubedl-android](https://github.com/yausername/youtubedl-android)

Algo del diseño de UI y código fue prestado de [Read You](https://github.com/Ashinch/ReadYou) y [Music You](https://github.com/Kyant0/MusicYou)
...
>[!Advertencia]
>
>Excepto por el source code licenciado en la licencia GPLv3,
>ninguna otra parte está habilitada de usar el nombre de Seal como aplicación de descarga
>y lo mismo aplica para los derivados de Seal.
>Derivados incluyen, pero limitados a, forks y builds no oficiales.

<div align="right">
<table><td>
<a href="#start-of-content">👆 Ir arriba de todo</a>
</td></table>
</div>
