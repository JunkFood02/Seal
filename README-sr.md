...
- Преузмите видео и аудио снимке с платформи за видео снимке које су подржане од [yt-dlp](https://github.com/yt-dlp/yt-dlp) (раније youtube-dl). 

- Уградите метаподатке и сличицу видео снимка у екстрактоване аудио фајлове који су подржани од [mutagen](https://github.com/quodlibet/mutagen). 
...
- Стабилна издања су такође доступна на [F-Droid](https://f-droid.org/packages/com.junkfood.seal/) 
...
Можете помоћи у превођењу апликације Seal на [Hosted Weblate](https://hosted.weblate.org/projects/seal/).
...
>**Упозорење**
>
>Осим изворног кода, лиценцираног под GPLv3 лиценцом, >свим другим странама је забрањено да користе Seal-ово име као апликацију за преузимање, 
>а исто важи и за Seal-ове деривате. >Деривати укључују, али нису ограничени на рачве кода и незваничне верзије. 
<div align="right">
<table><td>
