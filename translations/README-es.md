...
### Aplicación para descargar videos y audio en Android
...
- Descarga videos y archivos de audio desde plataformas compatibles con [yt-dlp](https://github.com/yt-dlp/yt-dlp) (anteriormente youtube-dl).

- Inserta metadatos y miniaturas en los archivos de audio extraídos, gracias al soporte de [mutagen](https://github.com/quodlibet/mutagen).

- Descarga todos los videos de una lista de reproducción con un solo clic.

- Utiliza [aria2c](https://github.com/aria2/aria2) integrado como gestor de descargas externo.

- Inserta subtítulos directamente en los videos descargados.

- Ejecuta comandos personalizados de yt-dlp mediante plantillas.

- Administra las descargas dentro de la app y gestiona tus propias plantillas de comandos.

- Interfaz fácil de usar y pensada para el usuario.

- Diseño moderno con [Material Design 3](https://m3.material.io/),incluyendo soporte para temas dinámicos.

- Desarrollo basado en MAD: interfaz y lógica escritas íntegramente en Kotlin. Arquitectura moderna con una sola Activity, sin Fragments, y navegación hecha exclusivamente con composables.



## ⬇️ Descarga

Para la mayoría de los dispositivos, se recomienda instalar la versión **arm64-v8a** de los archivos APK.

- Descarga la última versión estable desde la sección de [lanzamientos en GitHub](https://github.com/JunkFood02/Seal/releases/latest).
  - También puedes instalar las [versiones-preliminares](https://github.com/JunkFood02/Seal/releases/) si quieres ayudarnos a probar nuevas funciones y cambios.

- Las versiones estables también están disponibles en [F-Droid](https://f-droid.org/packages/com.junkfood.seal/)
...
Únete a nuestro [Telegram](https://t.me/seal_app) o a nuestro espacio en [Matrix](https://matrix.to/#/#seal-space:matrix.org) para charlas, novedades y lanzamientos.
...
Seal siempre será gratuito y de código abierto para todos. Si te gusta el proyecto, considerá [patrocinarme](https://github.com/sponsors/JunkFood02).¡Gracias!

## 🤝 Contribuciones

¡Las contribuciones son bienvenidas!

Puedes ayudar a traducir Seal desde [Hosted Weblate](https://hosted.weblate.org/projects/seal/).
	
[![Translate status](https://hosted.weblate.org/widgets/seal/-/strings/multi-auto.svg)](https://hosted.weblate.org/engage/seal/)
	
>[!Note]
>
>Para reportar errores, sugerir funciones, hacer preguntas u ofrecer cualquier otra idea para mejorar la aplicación, por favor consulta primero las instrucciones y guías en el archivo [CONTRIBUTING.md](https://github.com/JunkFood02/Seal/blob/main/CONTRIBUTING.md).
...
Seal es una interfaz gráfica simple para [yt-dlp](https://github.com/yt-dlp/yt-dlp), basada en [youtubedl-android](https://github.com/yausername/youtubedl-android).

Algunos diseños y fragmentos de código de la interfaz están tomados de [Read You](https://github.com/Ashinch/ReadYou) y [Music You](https://github.com/Kyant0/MusicYou).
...
>[!Warning]
>
>Exceptuando el código fuente, que está licenciado bajo GPLv3,
>no está permitido usar el nombre Seal para aplicaciones de descarga,
>ni tampoco en desarrollos derivados.
>Esto incluye, pero no se limita a, forks o compilaciones no oficiales.

<div align="right">
<table><td>
<a href="#start-of-content">👆 Volver al Inicio</a>
</td></table>
</div>
